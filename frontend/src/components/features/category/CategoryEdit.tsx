...
import type { CategoryNode } from "./CategoryCreate";
...
interface CategoryEditProps {
  ...
  onSubmit: (payload: { id: string; name: string; parent: string; position: string; status: string; description: string }) => Promise<void>;
  onCancel: () => void;
}
...
export default function CategoryEdit({ detail, categoryOptions, onSubmit, onCancel }: CategoryEditProps) {
